...
int main()
{
	...
	*/
	...
	int res5 = ft_printf("coucou %u ca va ?\n", INT_MAX);
    int res6 = printf   ("coucou %u ca va ?\n", INT_MAX);
	printf("\n");
	
    int res7 = ft_printf("coucou %i ca va ?\n", INT_MAX);
    int res8 = printf   ("coucou %i ca va ?\n", INT_MAX);
	printf("\n");
    
    int i = 0;
    int res9 = ft_printf("coucou %p ca va ?\n", &i);
    int res10 = printf  ("coucou %p ca va ?\n", &i);
	printf("\n");
     
    int res11 = ft_printf("coucou %d %s ca va ?\n", 42, "salut");
    int res12 = printf   ("coucou %d %s ca va ?\n", 42, "salut");
	printf("\n");

    int res13 = ft_printf("coucou %c %c ca va ?\n", 'H', 'G');
    int res14 = printf   ("coucou %c %c ca va ?\n", 'H', 'G');
	printf("\n");
   	  
    int res15 = ft_printf("coucou %d %d ca va ?\n", 42, 21);
    int res16 = printf   ("coucou %d %d ca va ?\n", 42, 21);
	printf("\n");
	
	char *nullstring = NULL;
	int res17 = ft_printf("%s\n", nullstring);
	int res18 = printf   ("%s\n", nullstring);
	printf("\n");
	
	char *nullstring2 = NULL;
	int res19 = ft_printf("%p\n", nullstring2);
	int res20 = printf   ("%p\n", nullstring2);
	printf("\n");
